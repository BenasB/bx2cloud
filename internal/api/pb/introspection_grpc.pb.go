...
func (c *introspectionServiceClient) Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*IntrospectionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IntrospectionResponse)
	err := c.cc.Invoke(ctx, IntrospectionService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterIntrospectionServiceServer(s grpc.ServiceRegistrar, srv IntrospectionServiceServer) {
	// If the following call pancis, it indicates UnimplementedIntrospectionServiceServer was
...
func _IntrospectionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntrospectionServiceServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IntrospectionService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntrospectionServiceServer).Get(ctx, req.(*emptypb.Empty))
	}
